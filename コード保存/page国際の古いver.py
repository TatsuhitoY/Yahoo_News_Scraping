...
def job_main(x):
    ...
    URL = "https://news.yahoo.co.jp/topics/world?page={}".format(x)
    ...
    # df.to_csv('/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Python_code/yahoo_analysis/csv 主要/主要{}.csv'.format(b), index = False)
    if x != 1:
        with open('/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Python_code/yahoo_analysis/csv 主要/国際全部.csv', 'a') as f:
            writer = csv.writer(f, lineterminator='\n')
            for ary in df.values:
                writer.writerow(ary)
    if x == 1:
        df.to_csv('/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Python_code/yahoo_analysis/csv 主要/国際全部.csv', index = False)
