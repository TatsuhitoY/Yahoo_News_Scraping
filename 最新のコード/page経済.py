...
def job_main():
    ...
    t_2 = a.strftime('%m-%d')
    file_name = '/Users/yoshiharatatsuhito/Desktop/T.Yoshihara/計算社会科学/Python_code/yahoo_analysis/データファイル/経済 {}.csv'.format(t_2)
    ...
    while True: #while文の最初の階層でcontinueが適用されると記事の情報が取得されず最後のprint文も機能せず、そのままスキップされる
        ...
        URL = "https://news.yahoo.co.jp/topics/business?page={}".format(news_page_num)
